...
public class ExisteUsuarioAñadidoWorker extends Worker {
    public ExisteUsuarioAñadidoWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        String direccion = "http://ec2-18-132-60-229.eu-west-2.compute.amazonaws.com/asanchez294/WEB/entrega2/existeUsuarioAñadido.php";
